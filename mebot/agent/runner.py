...
from mebot.agent.hook import AgentHook, AgentHookContext
from mebot.utils.prompt_templates import render_template
from mebot.agent.tools.registry import ToolRegistry
from mebot.providers.base import LLMProvider, ToolCallRequest
from mebot.utils.helpers import (
...
from mebot.utils.runtime import (
...
class AgentRunner:
    ...
    def _is_workspace_violation(cls, text: str) -> bool:
        """Check if text contains workspace/safety violation markers."""
        if not text:
            return False
        lowered = text.lower()
