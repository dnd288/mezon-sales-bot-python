...
class SkillsLoader:
    ...
    def _get_skill_meta(self, name: str) -> dict:
        """Get mebot metadata for a skill (cached in frontmatter)."""
        meta = self.get_skill_metadata(name) or {}
        return self._parse_mebot_metadata(meta.get("metadata", ""))
    ...
    def get_always_skills(self) -> list[str]:
        ...
        for s in self.list_skills(filter_unavailable=True):
            ...
            skill_meta = self._parse_mebot_metadata(meta.get("metadata", ""))
