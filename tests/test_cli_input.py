...
from mebot.cli import commands
...
def mock_prompt_session():
    ...
    with patch("mebot.cli.commands._PROMPT_SESSION", mock_session), \
         patch("mebot.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("mebot.cli.commands.PromptSession") as MockSession, \
         patch("mebot.cli.commands.FileHistory") as MockHistory, \
